...
class VendorAPIListPagination(PageNumberPagination):
    page_size = 3
...
class VendorListAPIView(APIView):
    permission_classes = [permissions.AllowAny]
    pagination_class = VendorAPIListPagination
    # authentication_classes = []
...
class VendorFilterAPIView(generics.ListAPIView):
    permission_classes = [permissions.AllowAny]
    pagination_class = VendorAPIListPagination
    queryset = Vendor.objects.all()
    serializer_class = VendorSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['name', 'email', 'second_name', 'phone_number', 'description']
    search_fields = ['name', 'email', 'second_name', 'phone_number', 'description']
...
class CustomerFilterAPIView(generics.ListAPIView):
    ...
    filter_backends = [DjangoFilterBackend, filters.SearchFilter]
    filterset_fields = ['email', 'name', 'second_name', 'phone_number', 'description', 'cart_number', 'address', 'post_code']
    search_fields = ['email', 'name', 'second_name', 'phone_number', 'description', 'cart_number', 'address', 'post_code']
